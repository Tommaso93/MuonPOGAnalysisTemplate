...
muonPogTree.Add("/eos/cms/store/user/battilan/NTuplesMuonPOG/muonPOGNtuple_SingleMuMinus_Flat_pt3-200.root")
muonPogTree.Add("/eos/cms/store/user/battilan/NTuplesMuonPOG/muonPOGNtuple_SingleMuPlus_Flat_pt3-200.root")
